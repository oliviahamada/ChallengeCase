...
> **Warning**: Leia com atenção 
 ...
 2. [Parâmetros](#parametros)
 3. [Dados de entrada](#entrada)
 4. [Dados de saída](#saida)
 ...
 * **Arquivos de entrada**:
	...
	- Assume-se que todos os arquivos seguirão o formato de input correto (você pode encontrar um [exemplo](https://github.com/oliviahamada/ChallengeCase/blob/master/ChallengeCase/Helper/json/exemplo.json) dentro da pasta Helper/json).
 </br>
 * **Arquivos de saída**:
